...
export const GeneratedImagesGrid: React.FC<GeneratedImagesGridProps> = ({ images, onToggleFavorite }) => {
                        ...
                        >
                            ...
                            {onToggleFavorite && (
                                <button
                                    onClick={(e) => {
                                        e.stopPropagation();
                                        onToggleFavorite(image.id + '-' + index);
                                    }}
                                    className="absolute top-3 right-3 p-2 rounded-full glass-morphism hover:bg-white/20 transition-all hover:scale-110 z-10"
                                    aria-label={image.favorite ? 'Remover dos favoritos' : 'Adicionar aos favoritos'}
                                >
                                    {image.favorite ? (
